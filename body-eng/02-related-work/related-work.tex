...
Given an input image, DECA first detects the facial landmarks and extracts the facial region. Then, it uses a convolutional neural network to extract the facial shape and expression parameters. The facial texture is extracted using a 3D texture space. Finally, the 3D model is rendered using the extracted parameters.
