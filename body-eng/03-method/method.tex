...
First, we define the anchor point of the hair object and the head object (Fig \ref{images/head_hair_sampled.png}) as the highest point of the mesh and the center of the mesh, respectively, from the top view.
