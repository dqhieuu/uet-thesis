...
% - The emotion-to-FLAME regressive model is a simple MLP (multi-layer perceptron) model with 6 input nodes and 56 output nodes.

The emotion-to-FLAME regressive model is a simple MLP (multi-layer perceptron) model with 6 input nodes and 56 output nodes, where the first 50 nodes . The model architecture is shown in the figure below.
