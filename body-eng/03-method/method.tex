...
\subsubsection{Create 3D avatar from a portrait image}

\subsubsection{Create 3D avatar with customized emotions}

\subsubsection{Try on different hairstyles with 3D avatar}
