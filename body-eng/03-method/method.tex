...
For taking a single-view portrait image as input, the system provides a front-end interface, i.e. a web page, where the user can upload their image. The system then takes the image and sends it to the back-end server, where the image is processed.
