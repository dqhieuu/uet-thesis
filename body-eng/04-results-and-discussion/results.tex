...
We use the pre-trained DECA model for face reconstruction. We allow the DECA to be swapped with other face reconstruction models such as MICA \cite{zielonkaMetricalReconstructionHuman2022} or EMOCA.
To train the emotion model, we use the VKIST dataset of 
...
% PSNR, SSIM, LPIPS, (DFID)
% Avg result
% 

\subsubsubsection{PSNR, SSIM, LPIPS}
